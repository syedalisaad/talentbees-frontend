...
export default function JobsListContent() {
  ...
  const handleSearch = () => {
    ...
    router.push(`/jobs/?${params_url.toString()}`);
  };
              ...
              : jobs.map((job) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 text-slate-500 text-sm font-medium mb-4">
                      ...
                      <MapPin size={14} /> {job.country?.name},{" "}
                      {job.city?.name}
                    </div>
                    ...
                    <div className="flex justify-between items-start gap-6">
                      ...
                      <div className="flex flex-col items-end gap-3">
                        ...
                        selectedJob?.is_applied == true ? (
                          <button
                            className="bg-yellow-300 text-slate-900 px-6 py-2.5 rounded-xl font-black text-[10px] tracking-widest uppercase transition-all flex items-center gap-2 shadow-lg disabled:opacity-70"
                            disabled
                          >
                            Already Applied
                          </button>
